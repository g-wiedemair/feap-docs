...
- [Mathematical Basis](theory/mathematical_basis.md)
- [Nonlinear Formulations](theory/nonlinear_mechanics.md)
...
# Project Evolution
- [Roadmap](roadmap.md)
- [Development History](history/overview.md)
    - [Phase 1: Core](history/walkthrough_phase1.md) | [Task List](history/task_phase1.md)
    - [Phase 2: GUI](history/walkthrough_phase2.md) | [Task List](history/task_phase2.md)
    - [Phase 3: Solver](history/walkthrough_phase3.md) | [Task List](history/task_phase3.md)
    - [Phase 3.5: System Update](history/walkthrough_phase3.5.md) | [Task List](history/task_phase3.5.md)
    - [Phase 4: SBEAM & Solvers](history/walkthrough_phase4.md) | [Task List](history/task_phase4.md)
    - [Phase 5: GUI Enhancements](history/walkthrough_phase5.md) | [Task List](history/task_phase5.md)
    - [Phase 6: Refactoring & Workflow](history/walkthrough_phase6.md) | [Task List](history/task_phase6.md)
    - [Phase 7: The Engineering Suite](history/walkthrough_phase7.md) | [Task List](history/task_phase7.md)
...
- [Crate Citations](reference/crate_citations.md)
